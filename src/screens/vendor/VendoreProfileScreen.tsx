...
const VendorProfileScreen: React.FC = () => {
  ...
  // Stats data
  const stats: Stat[] = [
    { label: 'Products', value: '24', icon: 'cube-outline' },
    { label: 'Orders', value: '156', icon: 'cart-outline' },
    { label: 'Reviews', value: '4.8', icon: 'star' },
    { label: 'Revenue', value: '₦2.5M', icon: 'cash-outline' },
  ];
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <View className='bg-[#ec4899] rounded-b-[30px] pb-4'>
          ...
          <View className="items-center pb-5">
            <TouchableOpacity activeOpacity={0.8} className="relative mb-4">
              ...
              <TouchableOpacity 
                className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-pink-500 justify-center items-center border-3 border-white"
                activeOpacity={0.7}
              >
        ...
        <View className="pt-5">
          ...
          <View className="mb-5 px-5">
            ...
            >
              <TouchableOpacity
                className="flex-row items-center justify-between p-4 bg-red-50 border-b border-gray-100"
              ...
              <TouchableOpacity
                className="flex-row items-center justify-between p-4 bg-red-50"
