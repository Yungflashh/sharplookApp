  ...
  return (
    <SafeAreaView style={ss.safe} edges={['top', 'bottom']}>
      ...
      >
        ...
        {/* Role tabs — Customer is active */}
        <View style={ss.roleTabs}>
          <View style={ss.roleTabActive}>
            <Text style={ss.roleTabActiveTxt}>Customer</Text>
          </View>
          <TouchableOpacity
            style={ss.roleTabInactive}
            onPress={() => navigation.replace('VendorRegister')}
            activeOpacity={0.8}
          >
            <Text style={ss.roleTabInactiveTxt}>Vendor</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={ss.field}>
          ...
          {referralValid === true && referrerName ? (
            <Text style={ss.referralSuccess}>🎉 Referred by {referrerName}. You'll get bonus rewards!</Text>
          ) : null}
        </View>
        ...
        >
          {loading
            ...
            : <><Text style={ss.btnTxt}>Create Account</Text><Ionicons name="chevron-forward" size={18} color="#fff" /></>
          }
        </TouchableOpacity>
