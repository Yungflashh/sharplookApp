  ...
  return (
    <View className={`mb-5 ${containerClassName}`}>
      <View className="relative">
        ...
        <TextInput
          {...props}
          className={`w-full ${icon ? 'pl-12' : 'pl-4'} ${rightIcon ? 'pr-12' : 'pr-4'} py-4 rounded-xl border bg-white text-black text-base ${inputClassName}`}
          style={{
            borderColor,
            ...props.style,
          }}
          placeholderTextColor={props.placeholderTextColor || '#D1D5DB'}
          onFocus={handleFocus}
          onBlur={handleBlur}
        />
