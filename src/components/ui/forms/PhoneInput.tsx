...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return <View className={`mb-5 ${containerClassName}`}>
      <View className="relative">
        ...
        <View className="w-full flex-row items-center px-4 py-4 rounded-xl border bg-white" style={{
        borderColor
      }}>
          <TouchableOpacity onPress={onCountryCodePress} className="flex-row items-center mr-3 pr-3 border-r border-gray-200" activeOpacity={0.7}>
          ...
          <TextInput {...props} className="flex-1 text-base text-black" value={value} onChangeText={onChangeText} placeholderTextColor="#D1D5DB" keyboardType="phone-pad" onFocus={handleFocus} onBlur={handleBlur} />
        </View>
      </View>
