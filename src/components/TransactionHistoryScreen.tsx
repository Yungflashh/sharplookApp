  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
              ...
              >
                ...
                <View className="flex-row gap-4">
                  ...
                  <TouchableOpacity 
                    ...
                    activeOpacity={0.7} 
                    onPress={() => {
                      if (currentUser?.vendorProfile?.kycStatus !== 'approved') { setKycModalVisible(true); return; }
      ...
      <KycGateModal
        ...
        onGoToKyc={() => { setKycModalVisible(false); (navigation as any).navigate('VendorStoreSettings'); }}
      />
    </SafeAreaView>
  );
};
