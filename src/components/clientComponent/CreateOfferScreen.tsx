      ...
      >
        ...
        >
          ...
          <View className="mb-5">
            ...
            <TextInput
              className={`border ${errors.title ? 'border-red-500' : 'border-gray-300'} rounded-xl px-4 py-3.5 text-base text-gray-900 bg-white`}
          ...
          <View className="mb-5">
            ...
            <TextInput
              className={`border ${errors.description ? 'border-red-500' : 'border-gray-300'} rounded-xl px-4 py-3.5 text-base text-gray-900 bg-white h-28`}
          ...
          <View className="mb-5">
            ...
            {loadingCategories ? (
              ...
              <View className="py-4 items-center bg-gray-50 rounded-xl">
                <Text className="text-gray-500 text-sm">No categories available</Text>
                <TouchableOpacity onPress={loadCategories} className="mt-2">
                  <Text className="text-purple-600 text-sm font-medium">Retry</Text>
                </TouchableOpacity>
              </View>
            ) : (
              <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mt-2">
                {categories.map(cat => (
                  <TouchableOpacity
                    ...
                    style={formData.category === cat._id ? { backgroundColor: '#9333ea' } : {}}
                    onPress={() => {
          ...
          <View className="mb-5">
            ...
            <View className="flex-row gap-2">
              {[
                ...
                { key: 'specific', label: 'Specific Date', icon: 'calendar-outline' },
                { key: 'urgent', label: 'Urgent', icon: 'flash-outline' }
              ].map(option => (
                <TouchableOpacity
                  key={option.key}
                  className={`flex-1 px-3 py-3 rounded-xl border flex-row items-center justify-center ${
                ...
                >
                  <Ionicons
                    ...
                    size={16}
                    color={formData.flexibility === option.key ? '#9333ea' : '#6b7280'}
                  />
                  <Text
                    className={`ml-1 text-xs font-medium ${
                      formData.flexibility === option.key ? 'text-purple-700' : 'text-gray-700'
                    }`}
                  >
                    {option.label}
                  </Text>
          ...
          {formData.flexibility !== 'flexible' && (
            <View className="mb-5">
              ...
              <View className="flex-row gap-3">
                <TextInput
                  className="flex-1 border border-gray-300 rounded-xl px-4 py-3.5 text-base text-gray-900 bg-white"
          ...
          <View className="mb-5">
            ...
            <TouchableOpacity
              ...
              } rounded-xl px-4 py-3.5 bg-white`}
                ...
                >
                  <Text
                    className={`text-center text-sm font-medium ${
                      formData.expiresInDays === days ? 'text-purple-700' : 'text-gray-700'
                    }`}
                  >
                    {days} days
                  </Text>
          ...
          <View className="mb-8">
            ...
            <TouchableOpacity
              className="border-2 border-dashed border-gray-300 rounded-xl p-6 items-center bg-white"
              onPress={pickImages}
        ...
        <View className="bg-white px-5 py-4 border-t border-gray-100">
          ...
          >
            {loading ? (
              ...
              <Text className="text-white font-semibold text-base">Submit Offer</Text>
            )}
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
