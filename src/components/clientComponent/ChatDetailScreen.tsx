      ...
      >
        ...
        >
          ...
          {messages.map((msg) => (
            <View
              key={msg.id}
              className={`mb-3 flex-row ${msg.isSent ? 'justify-end' : 'justify-start'}`}
            >
              {!msg.isSent && (
                <View className="w-8 h-8 rounded-full bg-pink-50 items-center justify-center mr-2">
              ...
              <View className={`max-w-[75%] ${msg.isSent ? 'items-end' : 'items-start'}`}>
                ...
                >
                  <Text
                    className={`text-sm ${msg.isSent ? 'text-white' : 'text-gray-900'}`}
                    style={{ lineHeight: 20 }}
                  >
                    {msg.text}
                  </Text>
