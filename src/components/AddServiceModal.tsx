...
const AddServiceModal: React.FC<AddServiceModalProps> = ({
  ...
  const [selectedImages, setSelectedImages] = useState<any[]>([]); // Changed to store full image objects
  ...
  const handleSave = async () => {
    ...
    setLoading(true);
    try {
      // Pass both formData and selectedImages to the parent
      ...
      >
        ...
        >
          ...
          <View className="mb-6 mt-5">
            ...
            <TextInput
              className={`border ${errors.name ? 'border-[#FF0000]' : 'border-gray-300'} rounded-xl px-4 py-3.5 text-base text-gray-900 bg-gray-50`}
          ...
          <View className="mb-6">
            ...
            <TextInput
              className={`border ${errors.description ? 'border-[#FF0000]' : 'border-gray-300'} rounded-xl px-4 py-3.5 text-base text-gray-900 bg-gray-50 h-24`}
              ...
              {categories.map((cat) => (
                <TouchableOpacity
                  ...
                  className={`px-4 py-2.5 rounded-full mr-2 ${
                    formData.category === cat._id ? 'border border-gray-300' : 'bg-gray-100 border border-gray-300'
                  }`}
          ...
          <View className="mb-6">
            ...
            <View className="flex-row flex-wrap gap-2 mt-2">
              {[15, 30, 45, 60, 90, 120].map((mins) => (
                <TouchableOpacity
                  key={mins}
                  className={`px-4 py-2 rounded-lg ${formData.duration === mins ? '' : 'bg-gray-100 border border-gray-300'}`}
              ...
              <View className="flex-1 flex-row items-center border border-gray-300 rounded-xl px-4 bg-gray-50">
                ...
                <TextInput
                  ...
                  onChangeText={(text) => {
                    ...
                    setFormData({
                      ...formData,
                      serviceArea: { ...formData.serviceArea, radius: km * 1000 }
                    });
                  }}
                  keyboardType="numeric"
                />
