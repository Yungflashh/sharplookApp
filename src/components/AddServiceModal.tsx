  ...
  return <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={handleClose}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 bg-white">
        ...
        <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          {}
          <View className="mb-6">
            <Text className="text-sm font-semibold text-gray-900 mb-2">Service Radius (km)</Text>
            <View className="flex-row items-center gap-3">
              <View className="flex-1 flex-row items-center border border-gray-300 rounded-xl px-4 bg-gray-50">
                ...
                <TextInput className="flex-1 py-3.5 px-3 text-base text-gray-900" placeholder="10" placeholderTextColor="#999" value={(formData.serviceArea.radius / 1000).toString()} onChangeText={text => {
              ...
              backgroundColor: '#eb278d'
                ...
                {loadingLocation ? <ActivityIndicator size="small" color="#fff" /> : <>
                    ...
                    <Text className="text-white text-sm font-medium ml-1">GPS</Text>
                  </>}
              </TouchableOpacity>
            </View>
          </View>
