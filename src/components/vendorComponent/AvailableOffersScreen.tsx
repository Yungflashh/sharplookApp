...
const AvailableOffersScreen: React.FC = () => {
  ...
  const fetchOffers = async () => {
    try {
      ...
      // Get user location for nearby offers
          ...
          <View className="bg-white rounded-t-3xl p-6" style={{ maxHeight: '80%' }}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View className="mb-6">
                ...
                <TextInput
                  className="border border-gray-300 rounded-xl px-4 py-3.5 text-base text-gray-900 h-24"
                  placeholder="Tell the client why you're the best fit..."
                  value={responseData.message}
                  onChangeText={(text) =>
                    setResponseData({ ...responseData, message: text })
                  }
                  multiline
                  numberOfLines={4}
            ...
            <View className="flex-row gap-3">
              ...
              >
                {submitting ? (
                  ...
                  <Text className="text-white font-semibold">Submit Response</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
